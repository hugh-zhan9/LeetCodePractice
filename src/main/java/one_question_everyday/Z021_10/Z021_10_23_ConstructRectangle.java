 ...
 * @author zyk
 * @description
 * @since 2021/10/23 8:38
 */
public class Z021_10_23_ConstructRectangle {
    ...
    public int[] constructRectangle(int area) {
        ...
        L =L>area/L ? L: area/L;    // 这个判断完全可以靠后面的这种写法而省略掉，没想到
        return new int[]{L,area/L};
    }

    /**
     * 执行用时：37 ms, 在所有 Java 提交中击败了24.35%的用户
     * 内存消耗：35.8 MB, 在所有 Java 提交中击败了58.72%的用户
     */
